...
# WEIGHT_FILE = 'work/model/Training/yolo_epoch199'
ANCHORS = [int(m) for m in args.anchors.split(",")]

# ANCHORS = [3, 5, 7, 10, 10, 13, 16, 30, 33, 23, 30, 61, 62, 45, 59, 119, 116, 90]
# ANCHORS = [3, 5, 7, 12, 10, 13, 14, 25, 17, 30, 27, 18, 35, 42, 81, 52, 63, 112]
...
if __name__ == '__main__':
    with fluid.dygraph.guard():
        ...
        total_results = []
        test_loader = test_data_loader(TESTDIR, batch_size= 16, mode='test')
